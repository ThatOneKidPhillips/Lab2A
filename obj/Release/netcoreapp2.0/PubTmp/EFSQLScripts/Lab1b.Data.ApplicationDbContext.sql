...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20180924173818_init')
BEGIN
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20180924173818_init')
BEGIN
    ALTER TABLE [AspNetUsers] ADD [BirthDate] int NOT NULL DEFAULT 0;
END;
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20180924173818_init')
BEGIN
    ALTER TABLE [AspNetUsers] ADD [FirstName] nvarchar(450) NOT NULL DEFAULT N'';
END;
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20180924173818_init')
BEGIN
    ALTER TABLE [AspNetUsers] ADD CONSTRAINT [AK_AspNetUsers_FirstName] UNIQUE ([FirstName]);
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20180924173818_init', N'2.0.1-rtm-125');
END;
